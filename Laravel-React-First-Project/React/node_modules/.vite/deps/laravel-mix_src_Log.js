...
var require_Log = __commonJS({
  "../node_modules/laravel-mix/src/Log.js"(exports, module) {
    ...
    var _Log = class _Log {
      ...
      static info(message, color = "default") {
        if (_Log.testing) {
          _Log.fakedLogs.push(message);
          return;
        }
        console.log(_Log.colors()[color], message);
        _Log.reset();
      }
      /**
       *
      ...
      static message(message) {
        if (_Log.testing) {
          _Log.fakedLogs.push(message.text);
          return;
        }
        let prefix = "";
      ...
      static line(message, color = "default") {
        _Log.info(message, color);
      }
      /**
       * Reset the default color for future console.logs.
       */
      static reset() {
        console.log(_Log.colors()["default"], "");
      }
      /**
       * Enter testing mode.
       */
      ...
      static received(messages) {
        ...
        let result = messages.every(
          (message) => this.fakedLogs.some((log) => log.includes(message))
        );
        this.restore();
        return result;
      }
     ...
     */
    __publicField(_Log, "testing", false);
    /**
     * All logged messages.
     *
     * @type {string[]}
     */
    __publicField(_Log, "fakedLogs", []);
    var Log = _Log;
    module.exports = Log;
  }
});
export default require_Log();
//# sourceMappingURL=laravel-mix_src_Log.js.map
